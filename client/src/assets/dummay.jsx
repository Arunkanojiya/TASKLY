...
export const menuItems = [
  { path: '/dashboard', text: 'Dashboard', icon: <HomeIcon className="w-4 h-4" /> },
  { path: '/tasks', text: 'Tasks', icon: <ListCheck className="w-4 h-4" /> },
  { path: '/profile', text: 'Profile', icon: <UserCircle className="w-4 h-4" /> }, 
  { path: '/settings', text: 'Settings', icon: <Settings className="w-4 h-4" /> },
];
