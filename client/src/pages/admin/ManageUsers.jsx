...
const ManageUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      const res = await axios.get("https://taskly-1i5r.onrender.com/api/admin/users", { headers: getHeaders() });
  ...
  const toggleBlock = async (userId, currentStatus) => {
    try {
      const url = currentStatus
        ? `https://taskly-1i5r.onrender.com/api/admin/user/unblock/${userId}`
        : `https://taskly-1i5r.onrender.com/api/admin/user/block/${userId}`;
  ...
  const handleAddUser = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://taskly-1i5r.onrender.com/api/admin/users", newUser, { headers: getHeaders() });
